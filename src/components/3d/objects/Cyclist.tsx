...
export const Cyclist = (props: CyclistProps) => {
    ...
    useEffect(() => {
        ...
        const wheelList = [modelData.getObjectByName('Wheel_back'), modelData.getObjectByName('Wheel_front')]
    ...
    return (
        <>
            {model && (
                <group scale={[0.028, 0.028, 0.028]} position={[props.x, 0, props.y]} rotation={[-Math.PI / 2, 0, (props.heading * Math.PI) / 180]}>
